...
export function calculateEloChanges(
  ...
  // For each player, calculate their rating change against all other players
  placements.forEach((playerId, playerIndex) => {
    ...
    // Compare against every other player in the game
    placements.forEach((opponentId, opponentIndex) => {
      if (playerId === opponentId) return; // Skip self
